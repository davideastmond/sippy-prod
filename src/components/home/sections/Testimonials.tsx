  ...
  return (
    <div className="flex overflow-hidden flex-col justify-center pb-24 w-full bg-white">
      ...
      <div className="lg:flex relative gap-10 items-start self-center p-8 max-w-full w-[1280px]">
        <div className="lg:overflow-hidden lg:self-stretch lg:pt-8 lg:pb-8 lg:pr-32 lg:pl-7 lg:my-auto text-lg leading-7 text-white lg:rounded-3xl lg:bg-neutral-700 lg:min-h-[464px] lg:min-w-[240px] lg:w-[668px] hidden lg:block">
          {testimonialContent}
        </div>

        <div className=" lg:overflow-hidden lg:absolute lg:right-8 lg:top-2/4 lg:z-0 lg:items-center bg-amber-400 lg:rounded-3xl lg:-translate-y-2/4 lg:min-w-[240px] lg:translate-x-[0%] lg:w-[608px] lg:h-[299px] hidden lg:block">
        ...
        <div className="lg:hidden flex flex-col gap-6">
          <div className="relative overflow-hidden bg-amber-400 rounded-3xl w-full h-[250px]">
            <Image
              src="/assets/images/testimonial.jpg"
              alt="Client testimonial"
              className="object-cover object-center"
